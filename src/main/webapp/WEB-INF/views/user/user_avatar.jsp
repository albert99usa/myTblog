        ...
        <div class="col-md-9">
            ...
            <div class="wrapper">
                ...
                <ul id="myTab" class="nav nav-tabs">
                    ...
                    <li class=""><a href="#get_avatar" data-toggle="tab">從Avatar獲取</a></li>
                </ul>
                    ...
                    <div class="tab-pane fade active in" id="upload_vatar">
                        ...
                        <form action="${contextPath}/user/changeAvatar" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="form-group">
                                <label class="control-label col-lg-2" for="file">選擇圖片檔</label>
                                <div class="col-lg-10">
                                    <input type="file" name="file" id="file">
                                    <span class="help-block">支援 500K 以內的 jpg/png 檔</span>
                                </div>
                            </div>
                            <div class="form-group">
