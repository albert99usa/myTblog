            ...
            <div class="wrapper">
                ...
                <form:form action="${contextPath}/user/info/${loginUser.username}" modelAttribute="userInfoForm" method="post" cssClass="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                                <%--     <form:input path="location" cssClass="form-control" id="location" placeholder="城市名即可，如蘇州"/>--%>
                            <form:input path="" cssClass="form-control" id="location" placeholder="城市名即可，如蘇州"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="slogan" class="col-lg-2 control-label">簽名</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group">
                        <label for="selfDesc" class="col-lg-2 control-label">個人簡介</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group">
                        <label for="githubUsername" class="col-lg-2 control-label">GitHub用戶名</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <form:hidden path="id"/>
                            <input type="submit" class="btn btn-primary" value="保存設置">
                        </div>
                    </div>
                </form:form>
            </div>
