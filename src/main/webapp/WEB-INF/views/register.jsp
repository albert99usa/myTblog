        ...
        <div class="row wrapper">
            ...
            <div class="col-sm-6">
                ...
                <form:form action="${contextPath}/register" modelAttribute="registerForm" method="post">
                    <h3 class="form-signin-header text-center">用戶註冊</h3>
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon">用戶名:</div>
                            <form:input path="username" cssClass="form-control" name="username" id="username" placeholder="請輸入用戶名"/>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <form:password path="password" cssClass="form-control" name="password" id="password" placeholder="請輸入密碼"/>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <form:input path="email"  cssClass="form-control" name="email" id="email" placeholder="電子郵件"/>
                        </div>
                    ...
                    <br>
                    <p>已經有帳戶？點擊<a href="${contextPath}/login">登陸</a></p>
                </form:form>
            </div>
