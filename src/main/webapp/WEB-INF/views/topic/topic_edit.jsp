    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <div class='container main'>
                                    ...
                                    <form method="post" action="${contextPath}/topic/edit/${topicVo.topicId}">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="title" class="form-control" placeholder="輸入文章標題" value="${topicVo.title}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <%--<div class="input-group">--%>
                                                <%--<div class="input-group-addon">內容:</div>--%>
                                                    <%--<textarea name="content" class="form-control" rows="12" placeholder="請輸入文章內容">${topicVo.content}</textarea>--%>
                                                        <%--</div>--%>
                                                            <div id="editormd">
            ...
            <div class='col-md-3'>
                <div class='panel'>
                    <div class='header'>
                        <span class='col_fade'>文章縮略圖</span>
                    </div>
                    <div class='inner'>
                        <style>
                            .dropzone {
